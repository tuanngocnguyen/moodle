    ...
    public function i_drag_to_in_the_drag_and_drop_markers_question($marker, $coordinates) {
        ...
        $this->execute_script("
                (function() {
                    ...
                    var xadjusted = {$x} * widthRatio + (container.offsetWidth - image.offsetWidth) / 2 + marker.offsetWidth / 2;
                    var yadjusted = {$y} * heightRatio + (container.offsetHeight - image.offsetHeight) / 2 + marker.offsetHeight / 2;
