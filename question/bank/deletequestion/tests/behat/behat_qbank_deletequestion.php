 ...
 */
class behat_qbank_deletequestion extends behat_question_base {

    /**
     * Apply filter
     *
     * @When I choose :not to show hidden questions
     * @When I choose to show hidden questions
     * @param string $not
     */
    public function i_choose_to_show_hidden_questions(bool $not = false) {
        // Type field.
