...
class helper_test extends \advanced_testcase {
     ...
     */
    private function get_quizzes_from_usages(array $usages): array {
        global $DB;
        // Get attempted quiz.
    ...
    public function test_get_quizziess(): void {
        ...
        $question1usages = helper::get_question_usages($question1->id);
        $question1quizzes = $this->get_quizzes_from_usages($question1usages);
        ...
        $question2usages = helper::get_question_usages($question2->id);
        $question2quizzes = $this->get_quizzes_from_usages($question2usages);
