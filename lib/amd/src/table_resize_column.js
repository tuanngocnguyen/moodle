 ...
 * @param {String} resizeContainer container class that will hold the resize handle.
 */
export const init = (id, dataAttr, resizeContainer) => {
    ...
    tableHeaders.forEach( header => {
        ...
        Templates.renderForPromise('core/resize_handle', context)
            .then(({html, js}) => {
                const container = header.querySelector(resizeContainer);
