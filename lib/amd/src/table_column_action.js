...
export const setUpPinHandle = (handleContainer, currentPinnedColumns, callback) => {
    ...
    let zIndex = 999;
    let left = 0;
    currentPinnedColumns.forEach(id => {
