...
const SELECTORS = {
    ...
    tableHeader: identifier => `th[data-${dataAttribute}="${identifier}"]`,
    tableColumn: identifier => `td[data-${dataAttribute}="${identifier}"]`,
};
...
export const setUpHideShowDropdown = () => {
 ...
 */
export const setUpTable = (id, dataAttr) => {
