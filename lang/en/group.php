...
$string['groupalreadyexists'] = 'Group \'{$a}\' already exists';
...
$string['groupmembershipadded'] = 'User \'{$a->user}\' added to group \'{$a->group}\'';
$string['groupmembershipexists'] = 'User \'{$a->user}\' is already a member of group \'{$a->group}\'';
$string['groupmembershipfailed'] = 'Failed to add user \'{$a->user}\' to group group \'{$a->group}\'';
...
$string['multipleusersfound'] = 'User id \'{$a->id}\' is mapped to multiple students ({$a->names})';
...
$string['notenrolledincourse'] = 'User \'{$a}\' is not enrolled in this course';
...
$string['usernameidmismatch'] = 'User \'{$a->name}\' does not match given user ID \'{$a->id}\'';
$string['usernotfoundskip'] = 'User \'{$a}\' not found. Skipping...';
